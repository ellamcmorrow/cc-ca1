...
// then its an old vector, increase the width of the new one by 10
  ...
  myp5.vertex(this.vectorOld.x-200, this.vectorOld.y-200)
  myp5.vertex(this.vector.x+200, this.vector.y+200); //draw  a line from the old vector xy to the new vector xy
  myp5.bezierVertex(this.vectorOld.x-200, this.vectorOld.y-200,this.vectorOld.x-200, this.vectorOld.y-20)
  myp5.bezierVertex(this.vector.x+200, this.vector.y+200,this.vector.x, this.vector.y); //draw  a line from the old vector xy to the new vector xy
  myp5.endShape();
