...
// then its an old vector, increase the width of the new one by 10
  ...
  if (this.vector.y < - 10) this.vector.y = this.vectorOld.y = myp5.height + 100;
  if (this.vector.y > myp5.height + 10) this.vector.y = this.vectorOld.y = -100;
  ...
  myp5.vertex(this.vector.x+20, this.vector.y+20); //draw  a line from the old vector xy to the new vector xy
  myp5.endShape();
